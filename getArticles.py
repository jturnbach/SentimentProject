...
cnn_business = newspaper.build('https://www.cnn.com/business', memoize_articles=False)
bbc = newspaper.build("https://www.bbc.com/news", memoize_articles=False)
bbc_business = newspaper.build("https://www.bbc.com/business", memoize_articles=False)
